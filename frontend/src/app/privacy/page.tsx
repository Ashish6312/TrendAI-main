      ...
      <div className="max-w-4xl mx-auto px-6 py-12">
        ...
        >
          ...
          <div className="space-y-8 text-slate-600 dark:text-gray-300 leading-relaxed font-medium">
            <section>
              <h2 className="text-2xl font-black text-slate-900 dark:text-white mb-4 uppercase tracking-tight">{t('priv_section_1')}</h2>
              <p>{t('priv_content_1')}</p>
            </section>

            <section>
              <h2 className="text-2xl font-black text-slate-900 dark:text-white mb-4 uppercase tracking-tight">{t('priv_section_2')}</h2>
              <p>{t('priv_content_2')}</p>
            </section>

            <section>
              <h2 className="text-2xl font-black text-slate-900 dark:text-white mb-4 uppercase tracking-tight">{t('priv_section_3')}</h2>
              <p>{t('priv_content_3')}</p>
            </section>

            <section>
              <h2 className="text-2xl font-black text-slate-900 dark:text-white mb-4 uppercase tracking-tight">{t('priv_section_4')}</h2>
              <p>{t('priv_content_4')}</p>
            </section>
